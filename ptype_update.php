...
ob_start();
include("conn.php");
                $rs = $conn->query("select * from product_type where product_type_id=" . $_GET['product_type_id']);
                $r = $rs->fetch_object();
                ...
                if (isset($_POST['Updateproducttype'])) {
                    ...
                    $sql = "UPDATE product_type SET product_type_name='$product_type_name'
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <form action="#" method="post">
                    <div class="head">
                        <h3>ฟอร์มบันทึกข้อมูลประเภทสินค้า</h3>
                    </div>
                    <hr>
                    <div class="add">
                        <table border="1" cellpadding="3" cellpadding="1">
                            <input type="hidden" name="product_type_id" value="<?= $r->product_type_id; ?>">
                            <label>ชื่อประเภทสินค้า</label>
                            <input type="text" class="form-control" name="product_type_name" value="<?= $r->product_type_name; ?>">
                    ...
                    <hr>
                    <div>
                        <input type="submit" name="Updateproducttype" value="แก้ไขข้อมูล" class="btn btn-warning">
                    </div>
                </form>
            </div>
