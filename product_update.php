...
$rs = $conn->query("select * from product where product_id=" . $_GET['product_id']);
$r = $rs->fetch_object();
...
if (isset($_POST['Updateproduct'])) {
    ...
    $sql = "UPDATE product SET product_name='$product_name' , product_price='$product_price'
         , product_amount='$product_amount', product_type_id='$product_type_id'
...
<form action="#" method="post">
    ...
    <div class="add">
        <table border="1" cellpadding="3" cellpadding="1">
            ...
            <input type="text" class="form-control" name="product_name" value="<?= $r->product_name; ?>">

            <label>ราคาสินค้า</label>
            <input type="number" class="form-control" name="product_price" value="<?= $r->product_price; ?>">

            <label>จำนวนสินค้า</label>
            <input type="number" class="form-control" name="product_amount" value="<?= $r->product_amount; ?>">

            <label>ประเภทสินค้า</label>
            <select class="form-control" name="product_type_id" id="product_type_id" value="<?= $r->product_type_id; ?>">
                <?php
                include("conn.php");
    ...
    <hr>
    <div>
        <input type="submit" name="Updateproduct" value="แก้ไขข้อมูล" class="btn btn-warning">
    </div>
</form>
</div>
