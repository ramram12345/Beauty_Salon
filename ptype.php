        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <p>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td bgcolor="#EEEEEE"><strong>ตารางแสดงรายละเอียดประเภทสินค้าในระบบ</strong></td>
                        </tr>
                    </table>
                </p>
                <button onclick="window.location='ptype_save.php';" class="btn btn-success">เพิ่มข้อมูล</button>
                <p class="search">
                ...
                <table width="80%" border="1" cellspacing="0" cellpadding="2" ">
                    <tr >
                        <td width=" 40" align="center" bgcolor="#66CDAA">รหัส</td>
                    <td align="center" bgcolor="#66CDAA">ชื่อประเภทสินค้า</td>
                    ...
                    if (isset($_GET['product_type_id'])) {
                        ...
                        $result = $conn->query("DELETE FROM product_type WHERE product_type_id=" . $_GET['product_type_id']);
                        if ($result == TRUE) {
                            echo "<script>";
                    ...
                    if ($_POST['Search']) {
                            ...
                            $sql .= " where product_type_name like '%$txt_search%' ";
                        }
                    ...
                    while ($row = $result->fetch_object()) {
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top" bgcolor="#fff"><?= $row->product_type_id; ?></td>
                            <td align="center" valign="top" bgcolor="#fff"><?= $row->product_type_name; ?></td>


                            <td align="center" valign="top" bgcolor="#fff">
                                <a href="ptype_update.php?product_type_id=<?= $row->product_type_id; ?>">
                                    <button type="button" class="btn btn-warning">แก้ไข</button>
                                </a>
                                <a href="ptype_type.php?product_type_id=<?= $row->product_type_id; ?>" onclick="return confirm('คุณต้องการลบข้อมูลใช่หรือไม่'); ">
