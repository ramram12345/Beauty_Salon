<?php 
include("conn.php");
            $rs = $conn->query("select * from services where services_id=" . $_GET['services_id']);
            $r = $rs->fetch_object();
            ...
            if (isset($_POST['Updateservices'])) {
                ...
                $sql = "UPDATE services SET services_name='$services_name', services_price='$services_price'
                ...
                <form action="#" method="post">
                    ...
                    <div class="add">
                        <table border="1" cellpadding="3" cellpadding="1">
                            <input type="hidden" name="services_id" value="<?= $r->services_id ?>">
                            <label>ชื่อบริการ</label>
                            <input type="text" class="form-control" name="services_name" value="<?= $r->services_name ?>">
                            <label>ราคา</label>
                            <input type="text" class="form-control" name="services_price" value="<?= $r->services_price ?>">
                        </table>
                    </div>
                    <hr>
                    <div>
                        <input type="submit" name="Updateservices" value="แก้ไขข้อมูล" class="btn btn-warning">
                    </div>
                </form>
            </div>
