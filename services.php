    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <button onclick="window.location='services_save.php';" class="btn btn-success">เพิ่มข้อมูล</button>
                <p class="search">
                ...
                <table width="60%" border="1" cellspacing="0" cellpadding="2" ">
                    <tr >
                        <td width=" 40" height="40" align="center" bgcolor="#66CDAA">รหัส</td>
                    <td align="center" bgcolor="#66CDAA">ชื่อสินค้า</td>
                    <td width="100" align="center" bgcolor="#66CDAA">ราคา</td>
                    ...
                    if (isset($_GET['services_id'])) {
                        ...
                        $result = $conn->query("DELETE FROM services WHERE services_id=" . $_GET['services_id']);
                        if ($result == TRUE) {
                            echo "<script>";
                    ...
                    if ($_POST['Search']) {
                            ...
                            $sql .= " where services_name like '%$txt_search%' ";
                        }
                    ...
                    while ($row = $result->fetch_object()) {
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top" bgcolor="#fff"><?= $row->services_id; ?></td>
                            <td align="center" valign="top" bgcolor="#fff"><?= $row->services_name; ?></td>
                            <td align="center" valign="top" bgcolor="#fff"><?= number_format($row->services_price, 2); ?></td>

                            <td align="center" valign="top" bgcolor="#fff">
                                <a href="Services_Update.php?services_id=<?= $row->services_id; ?>">
                                    <button type="button" class="btn btn-warning">แก้ไข</button>
                                </a>
                                <a href="Services.php?services_id=<?= $row->services_id; ?>" onclick="return confirm('คุณต้องการลบข้อมูลใช่หรือไม่'); ">
